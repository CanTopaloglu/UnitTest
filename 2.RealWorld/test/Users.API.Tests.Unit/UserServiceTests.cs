...
public class UserServiceTests
{
    ...
    [Fact]
    public async Task GetAllAsync_ShouldReturnsUsers_WhenSomeUserExists()
    {
        //Arrange
    ...
    [Fact]
    public async Task GetAllAsync_ShouldLogMessageAndException_WhenExceptionIsThrown() //Exception kontrolü
    {
        //Arrange
        var exception = new ArgumentException("User listesini geçerken bir hata ile karþýlaþtýk");
        ...
        logger.Received(1).LogError(Arg.Is(exception), Arg.Is("User listesini geçerken bir hata ile karþýlaþtýk"));
    }

    [Fact]
    public async Task CreateAsync_ShouldThrowAnError_WhenUserCreateDetailsAreNotValid()
    {
        //Arrange
    ...
    [Fact]
    public async Task CreateAsync_ShouldThrowAnError_WhenUserNameExists()
    {
        //Arrange
    ...
    [Fact]
    public async Task CreateAsync_ShouldCreateUserWhenDetailsAreValidAndUnique()
    {
        //Arrange
    ...
    [Fact]
    public async Task CreateAsync_ShouldLogMessagesAndException_WhenExceptionsIsThrown()
    {
        //Arrange
    ...
    [Fact]
    public async Task DeleteByIdAsync_ShouldThrowAnError_WhenUserNotExists()
    {
        //Arrange
        int userId = 1;
    ...
    [Fact]
    public async Task UpdateAsync_ShouldThrowAnError_WhenUserUpdateDetailsAreNotValid()
    {
        //Arrange
    ...
    public async Task UpdateAsync_ShouldLogMessages_WhenInvoked()
    {
        ...
        //Assert
        logger.Received(1).LogInformation(Arg.Is(
            "{0} kullanýcýnýn güncelleme iþlemi yapýlmaya baþlandý"),
            Arg.Any<string>());
    ...
    {
        //Arrange
        var exception = new ArgumentException("Kullanýcý güncelleme esnasýnda bir hatayla karþýlaþtý");
        userRepository.GetByIdAsync(updateUserDto.Id).Returns(user);
        userRepository.NameIsExists(updateUserDto.Name).Returns(false);
        ...
        logger.Received(1).LogError(
                      Arg.Is(exception),
                      Arg.Is("Kullanýcý güncelleme esnasýnda bir hatayla karþýlaþtý"));
    }
}